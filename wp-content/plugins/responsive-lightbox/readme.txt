...
Need more reasons? <a href="http://www.dfactory.co/products/responsive-lightbox/?utm_source=repo&utm_medium=link&utm_campaign=responsive-lightbox-plugin-free">Check them out here</a>!

= What some of our 100,000+ active users say about Responsive Lightbox and Gallery plugin =
...
* 8 responsive lightbox scripts (SwipeBox, prettyPhoto, Nivo Lightbox, Image Lightbox, Tos "R" Us, Featherlight, Magnific Popup, GLightbox)
...
* New: Enhanced admin interface with improved settings tabs and navigation
* New: Settings API architecture for better extensibility and maintainability
* Tweak: Gallery Builder improvements and UI enhancements
* Tweak: Improved settings validation and sanitization across all tabs
* Tweak: Better compatibility with WordPress 6.9
* Tweak: Enhanced gallery preview functionality and AJAX behaviors
* Fix: Folders drag-and-drop interaction with select-all functionality
* Fix: Folders taxonomy validation and data consistency
...
* New: WebP image format support across all lightbox scripts
* Security: Comprehensive security hardening for all lightbox scripts (XSS prevention, content sanitization)
* Security: Implemented DOMPurify for enhanced JavaScript content sanitization
* Tweak: prettyPhoto improvements - hardened content handling, fixed media cases, improved thumbnail display
* Tweak: Updated all third-party assets and dependencies for better security and performance
...
* New: Added caption font size option in galleries
* New: Added caption padding option in galleries
* Tweak: Set versions for scripts/styles of assets
...
= 2.7.7 =
Security hardening for Featherlight, prettyPhoto, and TosRUS, plus fixes for Featherlight sizing, cache-busted lightbox URLs, grouped lightbox settings saves, and a per-user Media Folders drag-and-drop toggle.