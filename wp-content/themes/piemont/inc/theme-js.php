<?php
	...
	add_action( 'wp_enqueue_scripts', 'piemont_enqueue_dynamic_js', '999' );

	function piemont_enqueue_dynamic_js( ) {
    ...
    $(document).ready(function() {
        ...
        <?php if(isset($piemont_theme_options['custom_js_code'])) {

        	echo piemont_wp_kses_data($piemont_theme_options['custom_js_code']);  // This variable contains user Custom JS code and can't be escaped with WordPress functions
